...
if(!isset($error) || $error == null){
    ...
    $chapOld = fixInput($_POST["chapOld"]);
    ...
    } else if($chap!=$chapOld && getChapterByIdManga($chap, $_POST['idManga'])){
    ...
    if(!isset($error) || $error == null){
    	...
    	if(!isset($error) || $error == null) {
	    	$insert = editChapterManga($id, $name, $chap);
	    	if($insert){
