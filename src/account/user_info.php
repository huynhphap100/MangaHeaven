    ...
    <table class="w3-table">
        <tr>
            ...
            <td style="width: 20%; max-height: 200px;">
                <div id="divAvatar" class="w3-display-container" style="width: 200px; max-height: 200px; border-radius: 50%;">
                    <img style="width: 100%; max-height: 200px; background-size: cover; opacity: 0;"
                         src="<?php echo $user["Avatar"]; ?>" alt="<?php echo $user["Account"]; ?>">
                    <img id="fileimage" class="w3-display-middle"
                         style="width: 100%; background-size: auto; display: block; margin: auto;"
                         src="<?php echo $user["Avatar"]; ?>" alt="<?php echo $user["Account"]; ?>">
                    <div id="textAvatar" class="w3-display-container w3-display-middle w3-gray"
                         style="width: 100%; height:100%; opacity: 0;"><h3
                                class="w3-display-middle w3-padding w3-white w3-round-large"
                                style="text-align: center;">Chọn ảnh</h3></div>
                    <input id="fileupload" class="w3-display-middle w3-button"
                           style="width: 100%; height:100%; opacity: 0;" type="file" name="uploadAvatar">
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Tên tài khoản</td>
            <td><input class="w3-black w3-border-0 w3-border-left w3-border-bottom" type="text" name="name"
                       placeholder="Tên hiển thị" value="<?php echo $user["Name"]; ?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <button id="submit" class="w3-white w3-hover-white w3-hover-opacity w3-btn w3-round-large"
                        style="padding-left: 20px; padding-right: 20px">Sửa
                </button>
            </td>
        </tr>
    </table>
