	...
	<div id="scrollManga" style="overflow: auto; max-height: 600px">
		...
		foreach($mangas as $manga){ ?>
			<tr class="w3-border w3-border-white">
				...
				<td style="width: 30%;">
					<center>
						<a class="w3-green w3-btn w3-hover-opacity w3-round-large" href="?action=user&group=editmanga&id=<?php echo $manga["Id"]; ?>">Sửa</a>
					</center>
				...
				<td style="width: 40%;">
					<center><a class="w3-green w3-btn w3-hover-opacity w3-round-large" href="?action=user&group=addchapter&id=<?php echo $manga["Id"]; ?>">Thêm tập</a></center>
					<div class="w3-container" id="scrollChaps" style="overflow: auto; max-height: 100px">
						...
						foreach ($chapters as $chap){ ?>
							<div class="w3-cell-row">
								...
								<a href="?action=user&group=removemanga&id=<?php echo $manga['Id']; ?>&idchap=<?php echo $chap['Chap']; ?>" class="w3-cell w3-btn w3-hover-opacity" style="width: 20%;"><i class="bi bi-trash"></i></a>
							</div>
						<?php } ?>
					</div>
				</td>
				<td style="width: 10%;">
					<a class="w3-red w3-btn w3-hover-opacity w3-round-large" href="?action=user&group=removemanga&id=<?php echo $manga["Id"]; ?>">Xoá</a>
				</td>
			</tr>
		<?php }	?>
		</table>
